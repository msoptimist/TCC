...
aqui começa a revisão metodológica do trabalho

\section{revisão metodológica}
\label{sec:revisaoMetodologica}
string de pesquisa: ((knowledge discovery) OR (knowledge extraction) OR (data mining)) AND (social media)
