...
%\imprimircapa                                               	           % Comando para imprimir Capa
	% REVER FONTE DO TEXTO
	% NOME AUTOR FORA DE PADRÃO
%\imprimirfolhaderosto{}                                     		   % Comando para imprimir Folha de rosto
	% NOME AUTOR FORA DE PADRÃO
	% Trabalho de Conclusão de Curso FORA DE PADRÃO
...
\textual								% INSERE ELEMENTOS TEXTUAIS
	% NUMERAÇÃO DE PÁGINAS FORA DE PADRÃO
\include{estrutura/textuais/introducao}                		           % Introdução
\include{estrutura/textuais/desenvolvimento/kdd}			% Descoberta do Conhecimento
\include{estrutura/textuais/desenvolvimento/redes-sociais}			% Redes Sociais
...
%\postextual 							% INSERE ELEMENTOS PÓS-TEXTUAIS
